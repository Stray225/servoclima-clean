    ...
    <footer className="bg-slate-950 border-t border-slate-800 text-white">
      ...
      <div className="border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-6 py-14 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="#cotizacion"
            className="flex-shrink-0 bg-amber-400 hover:bg-amber-300 text-slate-950 font-bold px-8 py-4 rounded-xl transition text-base shadow-xl shadow-amber-400/10"
          >
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-10">
        ...
        <div>
          <Image
            ...
            width={130}
            height={40}
            className="h-9 w-auto object-contain mb-4 brightness-200 opacity-70"
          />
          ...
          <div className="mt-5">
            <Image
              ...
              width={80}
              height={38}
              className="object-contain brightness-200 opacity-40"
            />
          </div>
        </div>

        <div>
          <p className="text-xs uppercase tracking-widest text-slate-600 mb-4 font-medium">Servicios</p>
          <ul className="space-y-2 text-sm text-slate-500">
            {["Instalaciones VRF/VRV", "Sistemas Chiller y Rooftop", "Contratos de mantenimiento", "Proyectos termomecánicos", "Ingeniería y consultoría", "Auditoría energética"].map((s) => (
              <li key={s}>
        ...
        <div>
          <p className="text-xs uppercase tracking-widest text-slate-600 mb-4 font-medium">Contacto</p>
          <div className="space-y-3 text-sm text-slate-500">
            <a href="tel:+541123579760" className="flex items-center gap-2.5 hover:text-white transition">
            ...
            <a href="https://wa.me/5491123579760" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 hover:text-white transition">
      ...
      <div className="border-t border-slate-900 py-4">
        <div className="max-w-7xl mx-auto px-6 text-center text-xs text-slate-700">
